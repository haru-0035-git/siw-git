...
class Game:
    ...
    def _start(self):
        print(f'{self._pokemon1.name}が現われた。{self._pokemon1.name}のパワーは{self._pokemon1.hp}だ。')
        print(f'{self._pokemon2.name}が現われた。{self._pokemon2.name}のパワーは{self._pokemon2.hp}だ。')
